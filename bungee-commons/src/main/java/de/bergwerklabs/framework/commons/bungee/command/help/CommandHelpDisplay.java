 ...
 *
 * <p>Class responsible for displaying command help.
 *
...
public class CommandHelpDisplay {
  ...
  /**
   * Displays the help to a player. The following shows how commands would be displayed.
   *
   * <pre>
   *     §bCommands:
        ...
        command -> {
          player.sendMessage(
              ...
              TextComponent.fromLegacyText(
                  "§e■§b " + command.getUsage() + "§7 - " + command.getDescription()));
        });
  }
}
