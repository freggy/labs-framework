 ...
 *
 * <p>Provides methods for text message handling in Minecraft using the Bungee API.
 *
...
public class MessageUtil {
  ...
  /**
   * Centers text and send it to the given player. <b>NOTE:</b> This may not work with custom
   * texture packs
   *
