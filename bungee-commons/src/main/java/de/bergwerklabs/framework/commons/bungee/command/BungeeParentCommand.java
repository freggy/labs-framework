...
public class BungeeParentCommand extends Command implements BungeeCommand {
  ...
  public BungeeParentCommand(
      ...
      String description,
      String usage,
      BungeeCommand defaultCommand,
      BungeeCommand... childCommands) {
    super(name);
    this.usage = usage;
  ...
  public Collection<BungeeCommand> getSubCommands() {
    return this.childCommandsMap.values();
  }
          ...
          .ifPresent(
              key -> {
                this.childCommandsMap
                    ...
                    .execute(
                        commandSender,
                        Arrays.copyOfRange(args, params.indexOf(args[0]) + 1, args.length));
              });
    }
  }
