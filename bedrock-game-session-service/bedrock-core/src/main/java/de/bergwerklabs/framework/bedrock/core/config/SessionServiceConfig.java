 ...
 *
 * <p>Stores the configuration for the {@link
 * de.bergwerklabs.framework.bedrock.core.BedrockSessionService}
 *
 * @author Yannic Rieger
 */
public class SessionServiceConfig {

  private boolean useAutoRespawn,
      incrementGamesPlayedOnGameStart,
      loadStatisticsOnJoin,
      spectatorsEnabled;
  ...
  /**
   * Gets a value indicating whether or not the games played statistic will be incremented on game
   * start.
   */
  ...
  /**
   * Gets the FQCN of {@link de.bergwerklabs.framework.bedrock.api.lobby.AbstractLobby} for this
   * session.
   */
  ...
  /**
   * Gets the FQCN of {@link de.bergwerklabs.framework.nabs.standalone.PlayerdataFactory} for this
   * session.
   */
  ...
  /**
   * Whether the spectator mode is enabled. If {@code true}, {@link
   * BlockCanBuildEvent#isBuildable()} will be set to {@code true}
   */
