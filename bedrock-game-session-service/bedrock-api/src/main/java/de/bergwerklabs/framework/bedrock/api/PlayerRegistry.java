 ...
 *
 * <p>Class which keeps track of every player that will play the game. The {@code PlayerRegistry} is
 * part of every {@link LabsGame}.
 *
...
public class PlayerRegistry<T extends LabsPlayer> {
  ...
  public Map<UUID, T> getSpectators() {
    return Collections.unmodifiableMap(spectators);
  }

  public Collection<T> getPlayerCollection() {
