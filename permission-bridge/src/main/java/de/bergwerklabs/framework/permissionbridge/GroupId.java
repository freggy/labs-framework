 ...
 *
 * <p>Provides useful methods for interacting with the group id. The group id consists of two parts:
 * The rank id prefix and the rank number.
 *
 * <pre>
 *     104
 *     │└┴─ Rank Number
...
public class GroupId {
  ...
  /**
   * Determines whether or not the player is in a social media subgroup. The range goes from 300 to
   * 399.
   */
