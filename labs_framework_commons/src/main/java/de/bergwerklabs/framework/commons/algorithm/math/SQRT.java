...
{
    /**
     * Very inaccurate square root calculation. About 5x as fast as {@link java.lang.Math#sqrt(double) Math.sqrt()}.
    ...
    /**
     * Inaccurate square root calculation. About 1.5x as fast as {@link java.lang.Math#sqrt(double) Math.sqrt()}.
     * Should be optimal for less important vector math.
     * @param d Squared value
     * @return Square root
     */
