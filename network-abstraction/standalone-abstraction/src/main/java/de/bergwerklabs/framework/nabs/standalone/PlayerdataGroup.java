...
public interface PlayerdataGroup {
  ...
  /**
   * Returns the value as {@link String} if possible. If the value is {@code null}, the {@code
  ...
  /**
   * Returns the value as {@link Integer} if possible. If the value is {@code null}, the {@code
   * defaultValue} will be returned.
   *
   * @param key the key to get the value for
   * @param defaultValue the value to return if there is no value set for the given key
  ...
  /**
   * Returns the value as {@link Double} if possible. If the value is {@code null}, the {@code
   * defaultValue} will be returned.
   *
   * @param key the key to get the value for
   * @param defaultValue the value to return if there is no value set for the given key
  ...
  /**
   * Returns the value as {@link Float} if possible. If the value is {@code null}, the {@code
   * defaultValue} will be returned.
   *
   * @param key the key to get the value for
   * @param defaultValue the value to return if there is no value set for the given key
  ...
  /**
   * Returns the value as {@link Byte} if possible. If the value is {@code null}, the {@code
   * defaultValue} will be returned.
   *
   * @param key the key to get the value for
   * @param defaultValue the value to return if there is no value set for the given key
  ...
  /**
   * Returns the value as {@link Long} if possible. If the value is {@code null}, the {@code
   * defaultValue} will be returned.
   *
   * @param key the key to get the value for
   * @param defaultValue the value to return if there is no value set for the given key
  ...
  /**
   * Returns the value as {@link Short} if possible. If the value is {@code null}, the {@code
   * defaultValue} will be returned.
   *
   * @param key the key to get the value for
   * @param defaultValue the value to return if there is no value set for the given key
  ...
  /**
   * Returns the value as {@link Object} if possible. If the value is {@code null}, the {@code
   * defaultValue} will be returned.
   *
   * @param key the key to get the value for
   * @param defaultValue the value to return if there is no value set for the given key
