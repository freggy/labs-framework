...
public class WrapperPlayServerCustomSoundEffect extends AbstractPacket {
   ...
   * Retrieve Sound Name.
   *
   * <p>Notes: all known sound effect names can be seen here.
   *
   ...
   *
   * <p>Notes: the category that this sound will be played from (current categories)
   *
   ...
   *
   * <p>Notes: effect X multiplied by 8 (fixed-point number with only 3 bits dedicated to the
   * fractional part)
   *
   ...
   *
   * <p>Notes: effect Y multiplied by 8 (fixed-point number with only 3 bits dedicated to the
   * fractional part)
   *
   ...
   *
   * <p>Notes: effect Z multiplied by 8 (fixed-point number with only 3 bits dedicated to the
   * fractional part)
   *
