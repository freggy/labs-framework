...
public class WrapperPlayServerTabComplete extends AbstractPacket {
   ...
   * Retrieve Count.
   *
   * <p>Notes: number of following strings
   *
   ...
   * Retrieve Match.
   *
   * <p>Notes: one eligible command, note that each command is sent separately instead of in a
   * single string, hence the need for Count
   *
