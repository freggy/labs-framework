...
public class WrapperPlayServerMapChunk extends AbstractPacket {
   ...
   *
   * <p>Notes: this is True if the packet represents all sections in this vertical column, where the
   * primary bit map specifies exactly which sections are included, and which are air
   *
