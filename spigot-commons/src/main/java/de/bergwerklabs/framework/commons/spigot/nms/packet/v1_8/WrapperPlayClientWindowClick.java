...
public class WrapperPlayClientWindowClick extends AbstractPacket {
   ...
   * Retrieve Window ID.
   *
   * <p>Notes: the id of the window which was clicked. 0 for player inventory.
   *
   ...
   * Retrieve Slot.
   *
   * <p>Notes: the clicked slot. See below.
   *
   ...
   * Retrieve Button.
   *
   * <p>Notes: the button used in the click. See below.
   *
   ...
   *
   * <p>Notes: a unique number for the action, used for transaction handling (See the Transaction
   * packet).
   *
