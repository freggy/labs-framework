...
public class WrapperPlayServerWorldParticles extends AbstractPacket {
   ...
   * Retrieve X.
   *
   * <p>Notes: x position of the particle
   *
   ...
   * Retrieve Y.
   *
   * <p>Notes: y position of the particle
   *
   ...
   * Retrieve Z.
   *
   * <p>Notes: z position of the particle
   *
   ...
   * Retrieve Offset X.
   *
   * <p>Notes: this is added to the X position after being multiplied by random.nextGaussian()
   *
   ...
   * Retrieve Offset Y.
   *
   * <p>Notes: this is added to the Y position after being multiplied by random.nextGaussian()
   *
   ...
   * Retrieve Offset Z.
   *
   * <p>Notes: this is added to the Z position after being multiplied by random.nextGaussian()
   *
   ...
   *
   * <p>Notes: the data of each particle
   *
   ...
   *
   * <p>Notes: the number of particles to create
   *
   ...
   *
   * <p>Notes: if true, particle distance increases from 256 to 65536.
   *
   ...
   * Retrieve Data.
   *
   * <p>Notes: length depends on particle. IRON_CRACK has a length of 2, BLOCK_CRACK and BLOCK_DUST
   * have lengths of 1, the rest have 0.
   *
