 ...
 *
 * <p>Main class for the chat commons.
 *
...
public class ChatCommons extends JavaPlugin implements Listener {
  ...
  /**
   * Gets the fitting {@link ChatColor} by the given color code. Valid color codes are: e.g {@code
   * §e} or {@code &e}
   *
   * @param colorCode can be {@code §e} or {@code &e} where {@code e} is the char specifying the
   *     color.
