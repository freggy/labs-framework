...
public class WrapperPlayClientTransaction extends AbstractPacket {
   ...
   * Retrieve Window ID.
   *
   * <p>Notes: the id of the window that the action occurred in.
   *
   ...
   *
   * <p>Notes: every action that is to be accepted has a unique number. This field corresponds to
   * that number.
   *
   ...
   * Retrieve Accepted.
   *
   * <p>Notes: whether the action was accepted.
   *
