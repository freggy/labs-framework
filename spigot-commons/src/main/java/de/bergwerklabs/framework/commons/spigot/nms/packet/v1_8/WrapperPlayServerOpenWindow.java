...
public class WrapperPlayServerOpenWindow extends AbstractPacket {
   ...
   * Retrieve Window id.
   *
   * <p>Notes: a unique id number for the window to be displayed. Notchian server implementation is
   ...
   *
   * <p>Notes: the window type to use for display. Check below
   *
   ...
   *
   * <p>Notes: the title of the window.
   *
   ...
   *
   * <p>Notes: number of slots in the window (excluding the number of slots in the player
   * inventory).
   *
