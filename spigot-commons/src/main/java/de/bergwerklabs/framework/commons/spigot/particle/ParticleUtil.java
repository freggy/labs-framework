...
public class ParticleUtil {
    ...
    public static void spawnParticle(Player player, EnumWrappers.Particle particle, int amount, Vector3F position, Vector3F maxOffset, float data, boolean longDistance) {
        PacketContainer container = createPacket(particle, amount, position, maxOffset, data, longDistance);
        try {
    ...
    private static PacketContainer createPacket(EnumWrappers.Particle particle, int amount, Vector3F position, Vector3F maxOffset, float data, boolean longDistance) {
