 ...
 *
 * <p>Provides Methods for serializing and deserializing scoreboards.
 *
...
public class LabsScoreboardFactory {
  ...
  private static final String DESERIALIZER_PATH =
      "de.bergwerklabs.framework.commons.spigot.scoreboard.version.{version}.LabsScoreboardDeserializer{version}";
  private static final String SERIALIZER_PATH =
      "de.bergwerklabs.framework.commons.spigot.scoreboard.version.{version}.LabsScoreboardSerializer{version}";

  private static VersionedJsonSerializer<LabsScoreboard> serializer =
      new VersionedJsonSerializer<>(SERIALIZER_PATH);
  private static VersionedJsonDeserializer<LabsScoreboard> deserializer =
      new VersionedJsonDeserializer<>(DESERIALIZER_PATH);

  private static Gson gson =
      new GsonBuilder()
          .setPrettyPrinting()
          .registerTypeAdapter(LabsScoreboard.class, deserializer)
