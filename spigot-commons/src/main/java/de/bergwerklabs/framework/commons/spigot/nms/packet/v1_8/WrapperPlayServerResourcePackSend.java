...
public class WrapperPlayServerResourcePackSend extends AbstractPacket {
   ...
   * Retrieve URL.
   *
   * <p>Notes: the URL to the resource pack.
   *
   ...
   * Retrieve Hash.
   *
   * <p>Notes: a 40 character hexadecimal and lower-case SHA-1 hash of the resource pack file. (must
   * be lower case in order to work) If it's not a 40 character hexadecimal string, the client will
   * not use it for hash verification and likely waste bandwidth - but it will still treat it as a
   * unique id
   *
