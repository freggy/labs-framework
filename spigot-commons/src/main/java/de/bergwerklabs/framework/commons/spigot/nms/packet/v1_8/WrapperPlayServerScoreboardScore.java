...
public class WrapperPlayServerScoreboardScore extends AbstractPacket {
   ...
   * Retrieve Score name.
   *
   * <p>Notes: the name of the score to be updated or removed.
   *
   ...
   *
   * <p>Notes: the name of the objective the score belongs to.
   *
   ...
   * Retrieve Value.
   *
   * <p>Notes: the score to be displayed next to the entry. Only sent when Update/Remove does not
   * equal 1.
   *
