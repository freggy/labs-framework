...
public class WrapperPlayServerScoreboardTeam extends AbstractPacket {
   ...
   * Retrieve Team Name.
   *
   * <p>Notes: a unique name for the team. (Shared with scoreboard).
   *
   ...
   *
   * <p>Notes: only if Mode = 0 or 2. Displayed before the players' name that are part of this team.
   *
   ...
   *
   * <p>Notes: only if Mode = 0 or 2. Displayed after the players' name that are part of this team.
   *
   ...
   *
   * <p>Notes: only if Mode = 0 or 2. always, hideForOtherTeams, hideForOwnTeam, never.
   *
   ...
   * Retrieve Color.
   *
   * <p>Notes: only if Mode = 0 or 2. Same as Chat colors.
   *
  ...
  /**
   * Get the collision rule. Notes: only if Mode = 0 or 2. always, pushOtherTeams, pushOwnTeam,
   * never.
   *
   ...
   * Retrieve Players.
   *
   * <p>Notes: only if Mode = 0 or 3 or 4. Players to be added/remove from the team. Max 40
   * characters so may be uuid's later
   *
   ...
   * Retrieve Mode.
   *
   * <p>Notes: if 0 then the team is created. If 1 then the team is removed. If 2 the team team
   * information is updated. If 3 then new players are added to the team. If 4 then players are
