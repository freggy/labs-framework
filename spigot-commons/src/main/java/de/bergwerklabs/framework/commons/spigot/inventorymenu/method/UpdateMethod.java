 ...
 *
 * <p>Method that gets called in a specific interval.
 *
...
public class UpdateMethod<T> {
  ...
  public static UpdateMethod fromJson(JsonElement json, LabsController controller) {
    ...
    if (json.isJsonObject()) {
      ...
      if (object.has("interval")) interval = object.get("interval").getAsInt();

      return new UpdateMethod(
          object.get("method").getAsString(), controller, interval, new ArrayList<>(params));
