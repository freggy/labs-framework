...
public final class LabsReflection {
    ...
    /**
     * Retrieves a {@link java.lang.reflect.Field} instance declared by the
     * specified class with the specified name. Java access modifiers are
     * ignored during this retrieval. No guarantee is made as to whether the
     * field returned will be an instance or static field.
     * <p>
     ...
     * {@link java.lang.reflect.Field#setAccessible(boolean) setAccessible} will
     * be invoked with an argument of {@code true} before it is returned. This
     * ensures that callers do not have to check or worry about Java access
     * modifiers when dealing with the returned instance.
     * </p>
     *
    ...
    /**
     * Retrieves a {@link java.lang.reflect.Method} instance declared by the
     * specified class with the specified name and argument types. Java access
     * modifiers are ignored during this retrieval. No guarantee is made as to
     * whether the field returned will be an instance or static field.
     * <p>
     ...
     * {@link java.lang.reflect.Method#setAccessible(boolean) setAccessible}
     * will be invoked with an argument of {@code true} before it is returned.
     * This ensures that callers do not have to check or worry about Java access
     * modifiers when dealing with the returned instance.
     * </p>
     * <p>
     ...
     */
    public synchronized static void setFieldValue(Field field, Object associatedObject, Object fieldValue) {
        try {
            field.setAccessible(true);
