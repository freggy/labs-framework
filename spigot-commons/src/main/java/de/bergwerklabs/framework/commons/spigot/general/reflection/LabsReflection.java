package de.bergwerklabs.framework.commons.spigot.general.reflection;
 ...
 */
public final class LabsReflection {
   ...
   * net.minecraft.server} versioned package. The class instances returned by this method are
   * cached, such that no lookup will be done twice (unless multiple threads are accessing this
  ...
  /**
   * Gets a {@link Class} object representing a type contained within the {@code
   * org.bukkit.craftbukkit} versioned package. The class instances returned by this method are
   * cached, such that no lookup will be done twice (unless multiple threads are accessing this
   * method simultaneously).
   *
   ...
   *
   * <p>The only match currently attempted by this method is a retrieval by using a parameterless
  ...
  /**
   * Retrieves a {@link java.lang.reflect.Field} instance declared by the specified class with the
   * specified name. Java access modifiers are ignored during this retrieval. No guarantee is made
   * as to whether the field returned will be an instance or static field.
   *
   * <p>A global caching mechanism within this class is used to store fields. Combined with
   * synchronization, this guarantees that no field will be reflectively looked up twice.
   *
   * <p>If a field is deemed suitable for return, {@link
   * java.lang.reflect.Field#setAccessible(boolean) setAccessible} will be invoked with an argument
   * of {@code true} before it is returned. This ensures that callers do not have to check or worry
  ...
  public static synchronized Field getField(Class<?> clazz, String name) {
    ...
    if (loaded.containsKey(name)) {
      // If the field is loaded (or cached as not existing), return the relevant value, which might
      // be null
  ...
  /**
   * Retrieves a {@link java.lang.reflect.Method} instance declared by the specified class with the
   * specified name and argument types. Java access modifiers are ignored during this retrieval. No
   * guarantee is made as to whether the field returned will be an instance or static field.
   *
   * <p>A global caching mechanism within this class is used to store method. Combined with
   * synchronization, this guarantees that no method will be reflectively looked up twice.
   *
   * <p>If a method is deemed suitable for return, {@link
   * java.lang.reflect.Method#setAccessible(boolean) setAccessible} will be invoked with an argument
   * of {@code true} before it is returned. This ensures that callers do not have to check or worry
   * about Java access modifiers when dealing with the returned instance.
   *
   * <p>This method does <em>not</em> search superclasses of the specified type for methods with the
   * specified signature. Callers wishing this behavior should use {@link
   ...
   * @param associatedObject Object/Class which the field is a member of.
   * @param fieldValue Value that the field should have.
   */
