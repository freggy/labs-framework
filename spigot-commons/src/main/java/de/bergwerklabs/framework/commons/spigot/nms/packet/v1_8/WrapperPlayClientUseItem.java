...
public class WrapperPlayClientUseItem extends AbstractPacket {
   ...
   *
   * <p>Notes: the position of the crosshair on the block, from 0 to 15 increasing from west to east
   *
   ...
   *
   * <p>Notes: the position of the crosshair on the block, from 0 to 15 increasing from bottom to
   * top
   *
   ...
   *
   * <p>Notes: the position of the crosshair on the block, from 0 to 15 increasing from north to
   * south
   *
