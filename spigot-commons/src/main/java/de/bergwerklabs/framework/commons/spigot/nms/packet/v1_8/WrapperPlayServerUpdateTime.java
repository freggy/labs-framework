...
public class WrapperPlayServerUpdateTime extends AbstractPacket {
   ...
   *
   * <p>Notes: in ticks; not changed by server commands
   *
   ...
   *
   * <p>Notes: the world (or region) time, in ticks. If negative the sun will stop moving at the
   * Math.abs of the time
   *
