...
public class WrapperPlayClientVehicleMove extends AbstractPacket {
   ...
   * Retrieve X.
   *
   * <p>Notes: absolute position (X coordinate)
   *
   ...
   * Retrieve Y.
   *
   * <p>Notes: absolute position (Y coordinate)
   *
   ...
   * Retrieve Z.
   *
   * <p>Notes: absolute position (Z coordinate)
   *
   ...
   * Retrieve Yaw.
   *
   * <p>Notes: absolute rotation on the vertical axis, in degrees
   *
   ...
   * Retrieve Pitch.
   *
   * <p>Notes: absolute rotation on the horizontal axis, in degrees
   *
