...
public class WrapperPlayServerLogin extends AbstractPacket {
   ...
   * Retrieve Gamemode.
   *
   * <p>Notes: 0: survival, 1: creative, 2: adventure. Bit 3 (0x8) is the hardcore flag
   *
   ...
   * Retrieve Dimension.
   *
   * <p>Notes: -1: nether, 0: overworld, 1: end
   *
   ...
   * Retrieve Difficulty.
   *
   * <p>Notes: 0 thru 3 for Peaceful, Easy, Normal, Hard
   *
   ...
   *
   * <p>Notes: used by the client to draw the player list
   *
   ...
   * Retrieve Level Type.
   *
   * <p>Notes: default, flat, largeBiomes, amplified, default_1_1
   *
