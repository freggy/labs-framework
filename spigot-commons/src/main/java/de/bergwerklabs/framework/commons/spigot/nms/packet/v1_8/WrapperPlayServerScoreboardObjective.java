...
public class WrapperPlayServerScoreboardObjective extends AbstractPacket {
   ...
   *
   * <p>Notes: an unique name for the objective
   *
   ...
   *
   * <p>Notes: only if mode is 0 or 2. The text to be displayed for the score.
   *
   ...
   *
   * <p>Notes: Can be either INTEGER or HEARTS
   *
   * @return
   */
   ...
   * Retrieve Mode.
   *
   * <p>Notes: 0 to create the scoreboard. 1 to remove the scoreboard. 2 to update the display text.
   *
