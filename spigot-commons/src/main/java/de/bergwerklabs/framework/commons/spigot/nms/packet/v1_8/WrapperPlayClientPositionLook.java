...
public class WrapperPlayClientPositionLook extends AbstractPacket {
   ...
   * Retrieve Feet Y.
   *
   * <p>Notes: absolute feet position. Is normally HeadY - 1.62. Used to modify the players bounding
   * box when going up stairs, crouching, etc…
   *
   ...
   * Retrieve Yaw.
   *
   * <p>Notes: absolute rotation on the X Axis, in degrees
   *
   ...
   * Retrieve Pitch.
   *
   * <p>Notes: absolute rotation on the Y Axis, in degrees
   *
   ...
   * Retrieve On Ground.
   *
   * <p>Notes: true if the client is on the ground, False otherwise
   *
