 ...
 */
package de.bergwerklabs.framework.commons.spigot.nms.packet.clientside.v1_8.tabcomplete;
...
public class WrapperPlayClientTabComplete extends AbstractPacket {
   ...
   *
   * <p>Notes: the position of the block being looked at. Only sent if the previous field is true
   *
