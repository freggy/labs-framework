 ...
 *
 * <p>Contains methods for dealing with NMS.
 *
...
public class NmsUtil {
  ...
  public static void sendPacketOverPlayerConnection(Player player, Object packetInstance) {
    try {
      ...
      Object connection =
          LabsReflection.getField(handle.getClass(), "playerConnection").get(handle);
      connection
          .getClass()
          .getMethod("sendPacket", LabsReflection.getNmsClass("Packet"))
          .invoke(connection, packetInstance);
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
