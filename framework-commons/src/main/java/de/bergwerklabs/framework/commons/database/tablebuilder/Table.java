...
public class Table {
   ...
   * @throws SQLArgumentException if the argument count is invalid or an argument has an invalid
   *     value
   */
  ...
  /**
   * Creates a prepared statement. <code>:table</code> will be replaced with the table name. <code>
   * :&lt;index&gt;</code> will be replaced with the corresponding column name.
   *
