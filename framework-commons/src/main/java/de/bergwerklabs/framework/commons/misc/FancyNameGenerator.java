...
public class FancyNameGenerator {
  ...
  static {
    ...
    for (Row row : nounResult.getRows()) {
      NOUNS.add(new Noun(row.getString("noun"), getArticle(row.getString("gender"))));
    }
   ...
   * @deprecated Use {@link
   *     de.bergwerklabs.framework.commons.misc.instantiable.FancyNameGenerator#generate(long)}
   */
  @Deprecated
   ...
   * @return the generated fancy name
   * @deprecated Use {@link
   *     de.bergwerklabs.framework.commons.misc.instantiable.FancyNameGenerator#generate(String)}
   */
  @Deprecated
