...
public class GridNode extends Node<GridCoordinate> {
   ...
   * @return the node at the given position. <code>null</code> if none was found or the coordinates
   *     are out of board.
   */
  public static Node<GridCoordinate> findNode(
      Node<GridCoordinate>[] nodes, int row, int col, int gridSize) {
