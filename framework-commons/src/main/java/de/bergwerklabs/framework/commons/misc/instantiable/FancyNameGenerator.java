...
public class FancyNameGenerator {
    ...
    static {
        ...
        if (NOUNS_FILE.exists()) {
            try {
                JsonArray array = gson.fromJson(new BufferedReader(new FileReader(NOUNS_FILE)), JsonArray.class);
        ...
        if (ADJECTIVES_FILE.exists()) {
            try {
                JsonArray array = gson.fromJson(new BufferedReader(new FileReader(ADJECTIVES_FILE)), JsonArray.class);
                for (JsonElement element : array) {
