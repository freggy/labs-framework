...
public class TableBuilder {
  ...
  public TableBuilder addBigDecimalColumn(
      String name, BigDecimal defaultValue, ColumnFlag... flags) {
  ...
  public TableBuilder addStringColumn(
      String name, int maxLength, String defaultValue, ColumnFlag... flags) {
